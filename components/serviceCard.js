...
const ServiceCard = ({image,name,id,type}) => {
  return (
    ...
    <div className='min-[1260px]:w-[400px] min-[1260px]:h-[300px] w-[300px] h-[200px] mx-auto relative group'>
        ...
        <p className={`${name.length<20?"text-4xl":"text-2xl"} font-bold text-center min-[426px]:text-transparent min-[426px]:group-hover:text-white text-white absolute min-[1260px]:w-[400px] min-[1260px]:h-[300px] w-[300px] h-[200px] top-[45%] duration-200`}>{name}</p>
        </Link>
    </div>
